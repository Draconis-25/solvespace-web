    ...
    <section class="feature-grid">
        ...
        <div class="feature-card">
            ...
            <ul>
                ...
                <li>
                    lengths in metric or imperial units
                </li>
                <li>
        ...
        <div class="feature-card">
            <h3>
                Parametric & Associative Assembly:
            </h3>
            <ul>
                <li>
        ...
        <div class="feature-card">
            ...
            <ul>
                <li>measurements on a part or assembly (of point coordinates, line length, point-point distance, point-face distance, projected distance, face-face angle, point-line distance)</li>
